...
if (($activePage !== 'index') && ($activePage !== 'dashboard')) {
	...
	echo '"><a href="live.php"><span class="da live"></span><span>Canais</span></a></li>          ' . "\r\n" . '          <li class="';

	if ($activePage == 'movies') {
		echo 'active';
	}

	echo '"><a href="movies.php"><span class="da movie"></span><span>Filmes</span></a></li>' . "\r\n" . '          <li class="';

	if ($activePage == 'series') {
		echo 'active';
	}

	echo '" ><a href="series.php"><span class="da tv"></span><span>Séries</span></a></li>' . "\r\n" . '          <li class="';

	if ($activePage == 'radio') {
		echo 'active';
	}

	echo '" ><a href="radio.php"><span class="da radio"></span><span>Rádio</span></a></li>' . "\r\n" . '          <li class="';

	if ($activePage == 'catchup') {
		echo 'active';
	}

	echo '"><a href="catchup.php"><span class="da catchup"></span><span>Gravações</span></a></li>' . "\r\n" . '          <!-- <li class="';
