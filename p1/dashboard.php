...
echo '        <h4 class="text-center" style="color: #fff; top: 50px; float:left;width: 100%;position: relative;    text-transform: uppercase;">Validade do Plano: ';
echo $ExpiryData;
echo '</h4>' . "\r\n" . '    </div>' . "\r\n" . '</div>' . "\r\n" . '</div>' . "\r\n";
